...
@Component({
  selector: 'app-product-colors-inactive-page',
  standalone: true,
  ...
  templateUrl: './product-colors-inactive-page.component.html',
  styleUrl: './product-colors-inactive-page.component.css'
})
export class ProductColorsInactivePageComponent {
  id: number = 0;
  product: any;
